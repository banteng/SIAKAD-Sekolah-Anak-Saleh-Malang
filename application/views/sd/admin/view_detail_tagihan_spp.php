<div class="row">
                                ...
                                <div class="adv-table">
                                    <table  class="display table table-bordered table-striped" id="example">
                                      ...
                                      <?php 
                                          ...
                                          $no = 1;
                                          //$bul1 = array("Januari", "Februari", "Maret", "April", "Mei", "Juni");
                                          //$bul2 = array("Juli", "Agustus", "September", "Oktober", "November", "Desember");
                                      ...
                                      ?>
                                          <tr>
                                            ...
                                            <td>Rp. <?php echo rupiah($spp->NOMINAL_SPP);?></td>
                                              ...
                                              <?php if($cek->STATUS == "1"){ ?>
                                             <td><button type="button" class="btn btn-success btn-sm"><i class="fa fa-trash"></i> TERBAYAR</button></td>
                                        </tr>
                                        <?php 
                                              }else{ ?>
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url();?>sd/admin/home/bayarSPP/<?php echo $spp->NIS;?>/<?php echo $bulans->ID;?>">
