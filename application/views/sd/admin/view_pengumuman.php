...
<div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="btn-group">
                                 <a href="<?php echo base_url('sd/admin/tambah-pengumuman');?>"> <button class="btn green">Tambah Data <i class="icon-plus"></i>
                                  </button></a>
                              </div>
                                <div class="adv-table">
                                    <table  class="display table table-bordered table-striped" id="example">
                                      ...
                                      ?>
                                        <tr>
                                          ...
                                          <td>
                                          <a href="<?php echo base_url();?>sd/admin/home/detailPengumuman/<?php echo $data->ID;?>"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-eye "></i> Detail</button></a>
                                        ...
                                        <div class="modal fade" id="modal_hapus<?php echo $data->ID;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                                            ...
                                            <form class="form-horizontal" method="post" action="<?php echo base_url().'sd/admin/home/hapusPengumuman/'.$data->ID?>">
