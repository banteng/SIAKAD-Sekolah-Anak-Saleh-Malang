...
<script src="<?php echo base_url('backup/jquery/jquery-2.2.3.min.js')?>"></script>
<script src="<?php echo base_url('backup/bootstrap/js/bootstrap.min.js')?>"></script>
...
<div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="btn-group">
                                 <a href="<?php echo base_url('sd/admin/tambah-siswa');?>"> <button class="btn green">Tambah Data <i class="icon-plus"></i>
                                  </button></a>
                              </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                     <select name="mapel" id="pilihmapel" class="form-control">
                                                         ...
                                                         <option value="<?php echo $pm->ID;?>"><?php echo $pm->GRADE;?> <?php echo $pm->NAMA_KELAS;?></option>
                                                         <?php } ?>
                                                     </select>
                                                </div>
                                            </div>
                                      ...
                                      ?>
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <a href="<?php echo base_url();?>sd/admin/home/editSiswa/<?php echo $data->NIS;?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o "></i> Edit</button></a>
                                        ...
                                        <div class="modal fade" id="modal_hapus<?php echo $data->NIS;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                                          ...
                                          <form class="form-horizontal" method="post" action="<?php echo base_url().'sd/admin/home/hapusSiswa/'.$data->NIS?>">
...
$(document).ready(function(){
    $('#pilihmapel').on('change', function(){
        var id = $(this).val();
        location.href = '<?php echo base_url("sd/admin/siswa/");?>'+id;
    })
    $('#tabelSoal').DataTable();
})
</script>
