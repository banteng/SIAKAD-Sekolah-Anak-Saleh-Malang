                                    ...
                                    ?>
                                      ...
                                      <td>
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm"><i class="fa fa-check "></i> SAKIT</button>
                                          ...
                                          <?php }else{?>
                                           <a href="<?php echo base_url();?>sd/admin/home/presensiMasuk/<?php echo $data->NIS; ?>"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-check "></i> Masuk</button></a>
                                          <a href="<?php echo base_url();?>sd/admin/home/presensiIzin/<?php echo $data->NIS; ?>"><button type="button" class="btn btn-info btn-sm"><i class="fa fa-info-circle "></i> Izin</button></a>
                                          <a href="<?php echo base_url();?>sd/admin/home/presensiSakit/<?php echo $data->NIS; ?>"><button type="button" class="btn btn-warning btn-sm"><i class="fa fa-bed "></i> Sakit</button></a>
                                          <?php }?>
                                      </td>
                                      </tr>
                                      <?php endforeach;?>
