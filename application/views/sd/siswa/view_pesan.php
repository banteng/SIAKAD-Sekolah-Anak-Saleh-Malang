    ...
    var initializeChat = function() {
        ...
        $('.msg-wgt-active').each(function(index, el) {
            ...
            chatInterval.push(setInterval(function() {
                ...
                var oldLength = 0;
                $.post('<?= site_url('siswa/home/getChat') ?>', {chatWith: $data.chatWith}, function(data, textStatus, xhr) {
            ...
            $that.find('textarea').on('keydown', function(e) {
                ...
                if (e.keyCode === 13 && e.shiftKey === false) {
                    $.post('<?= site_url('siswa/home/sendMessage') ?>', {message: $textArea.val(), chatWith: $data.chatWith}, function(data, textStatus, xhr) {
                    });
