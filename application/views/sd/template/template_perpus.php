                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="<?php echo base_url('sd/perpustakaan/logout'); ?>"><i class="icon-key"></i> Log Out</a></li>
                        </ul>
                    </li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a class="active" href="<?php echo base_url('sd/perpustakaan/dashboard'); ?>">
                          <i class="icon-dashboard"></i>
                          <span>Dashboard</span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('sd/perpustakaan/absensi'); ?>" >
                          <i class=" icon-archive"></i>
                          <span>Data Buku </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('sd/perpustakaan/pembayaran'); ?>" >
