                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url();?>paud/admin/home/updatePegawai/<?php echo $pegawai->NIP; ?>" enctype="multipart/form-data">
                                      ...
                                      <select class="form-control" name="status">
                                            <option>-- Pilih Status Pegawai --</option>
                                                ...
                                                foreach($status as $data){
                                                    if($data->STATUS_KEPEGAWAIAN==$pegawai->STATUS_PEGAWAI){
                                                        echo "<option value='".$data->STATUS_KEPEGAWAIAN."'selected>".$data->STATUS_KEPEGAWAIAN."</option>";
                                                    }else{
