          <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="btn-group">
                                 <a href="<?php echo base_url('paud/admin/tambah-pegawai');?>"> <button class="btn green">Tambah Data <i class="icon-plus"></i>
                                  </button></a>
                                  <a href="<?php echo base_url('paud/admin/status-pegawai');?>"> <button class="btn green">Tambah Status Pegawai <i class="icon-plus"></i>
                                  </button></a>
                                  <a href="<?php echo base_url('paud/admin/import-pegawai');?>"> <button class="btn green">Import Data <i class="icon-paper"></i>
                                  </button></a>
                              </div>
                                      ...
                                      ?>
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <a href="<?php echo base_url();?>paud/admin/home/editPegawai/<?php echo $data->NIP;?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o "></i> Edit</button></a>
                                        ...
                                        <div class="modal fade" id="modal_hapus<?php echo $data->NIP;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                                          ...
                                          <form class="form-horizontal" method="post" action="<?php echo base_url().'paud/admin/home/hapusPegawai/'.$data->NIP?>">
