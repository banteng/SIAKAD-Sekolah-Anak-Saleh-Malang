                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url();?>paud/admin/home/prosesSiswa" enctype="multipart/form-data">
                                  ...
                                  <!--<div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                       <input type="text" class="form-control" name="spp" required=""> 
                                      </div>
                                  </div>-->
                                  <div class="form-group">
