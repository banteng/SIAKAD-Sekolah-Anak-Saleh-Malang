                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url();?>paud/admin/home/setTagihan" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                      <select class="form-control" name="siswa" required="" id="siswa">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">Tahun Tagihan</label>
                                      <div class="col-sm-10">
                                        <select name="tahun" class="form-control">
                                            <option selected="selected">-- Pilih Tahun Tagihan --</option>
                                            <?php
