                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="<?php echo base_url('kesiswaan/login/logout'); ?>"><i class="icon-key"></i> Log Out</a></li>
                        </ul>
                    </li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a class="active" href="<?php echo base_url('paud/kesiswaan/dashboard'); ?>">
                          <i class="icon-dashboard"></i>
                          <span>Dashboard</span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('paud/kesiswaan/absensi'); ?>" >
                          <i class=" icon-archive"></i>
                          <span>Absensi </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('kesiswaan/pengaduan-masalah'); ?>" >
                          <i class=" icon-pencil"></i>
                          <span>Pengaduan Masalah </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('paud/kesiswaan/pengumuman'); ?>" >
                          <i class="icon-bell-alt"></i>
                          <span>Pengumuman </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('paud/kesiswaan/pesan'); ?>" >
