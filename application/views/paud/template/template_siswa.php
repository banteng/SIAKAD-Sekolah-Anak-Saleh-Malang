                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="<?php echo base_url('paud/siswa/login/logout'); ?>"><i class="icon-key"></i> Log Out</a></li>
                        </ul>
                    </li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a class="active" href="<?php echo base_url('paud/siswa/dashboard'); ?>">
                          <i class="icon-dashboard"></i>
                          <span>Dashboard</span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('paud/siswa/elearning'); ?>" class="hidden">
                          <i class=" icon-file"></i>
                          <span>E-Learning </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('paud/siswa/absensi'); ?>" >
                          <i class=" icon-archive"></i>
                          <span>Absensi </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('paud/siswa/pembayaran'); ?>" >
                          <i class=" icon-dollar"></i>
                          <span>Pembayaran </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('paud/siswa/perpustakaan'); ?>" >
                          <i class=" icon-book"></i>
                          <span>Perpustakaan </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('paud/siswa/pengumuman'); ?>" >
                          <i class="icon-bell-alt"></i>
                          <span>Pengumuman </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('paud/siswa/pesan'); ?>" >
