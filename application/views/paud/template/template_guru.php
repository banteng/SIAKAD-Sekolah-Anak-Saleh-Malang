                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="<?php echo base_url('paud/guru/reset-password'); ?>"><i class=" icon-cog"></i>Reset Password</a></li>
                            <li><a href="<?php echo base_url('paud/guru/login/logout'); ?>"><i class="icon-key"></i> Log Out</a></li>
                        </ul>
                    </li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                    <li>
                        <a class="active" href="<?php echo base_url('paud/guru/dashboard'); ?>">
                            <i class="icon-dashboard"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                  <?php if($this->db->query("SELECT * FROM tb_kelas WHERE WALI_KELAS ='".$this->session->userdata('nip')."'")){?>
                    <li>
                      <a href="<?php echo base_url('paud/guru/siswa'); ?>" >
                          <i class="icon-user"></i>
                  ...
                  <?php }?>
                   <li>
                      <a href="<?php echo base_url('paud/guru/penilaian'); ?>" >
                          <i class=" icon-file"></i>
                          <span>Penilaian </span>
                      </a>
                  </li>
                  <li>
                        <a href="<?php echo base_url('paud/guru/pengumuman'); ?>" >
                            <i class="icon-bell-alt"></i>
                            <span>Pengumuman </span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('paud/guru/pesan'); ?>" >
