<div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="btn-group">
                          <a href="<?php echo base_url('admin/tambah-pembayaran-lain.html');?>"> <button class="btn green">Tambah Data <i class="icon-plus"></i>
                                  </button></a>
                              </div>
                                      ...
                                      ?>
                                        <tr>
                                          ...
                                          <a href="#"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-eye "></i> Detail</button></a>
                                            <a href="<?php echo base_url();?>admin/home/editSiswa/<?php echo $data->ID;?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o "></i> Edit</button></a>
