...
<head>
    ...
    <title>Sekolah Anak Saleh Malang</title>
    <link rel="icon" href="img/fav.png" type="image/x-icon">

    <!-- Bootstrap -->
    <link href="<?php echo base_url();?>templates/box/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url();?>templates/box/ionicons/css/ionicons.min.css" rel="stylesheet">
...
position: absolute;
  ...
  width:100px;
    ...
    <!-- modernizr -->
    <script src="<?php echo base_url();?>templates/box/js/modernizr.js"></script>
...
<body>
    <div class="container">
        <div class="box box-1">
            <a href="<?php echo base_url('paud'); ?>"><div class="cover"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/945546/3433202-893bc9989a52eba0.png" alt=""></div></a>
            <a href="<?php echo base_url('paud'); ?>"><button><div></div></button></a>
        </div>
        <div class="box box-2">
            <a href="<?php echo base_url('tk'); ?>"><div class="cover"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/945546/3433202-964edcf0f07211b0.png" alt=""></div></a>
            <a href="<?php echo base_url('tk'); ?>"><button><div></div></button></a>
        </div>
        <div class="box box-3">
            <a href="<?php echo base_url('sd'); ?>"><div class="cover"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/945546/3433202-2ebb2b6f93add843.png" alt=""></div></a>
            <a href="<?php echo base_url('sd'); ?>"><button><div></div></button></a>
        </div>
