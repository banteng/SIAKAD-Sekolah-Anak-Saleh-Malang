...
<html lang="en">
  ...
  <section id="container" >
      ...
      <header class="header white-bg">
            ...
            <!--logo start-->
          <a href="<?php echo base_url('tk/admin/dashboard'); ?>" class="logo"><img src="<?php echo base_url('');?>upload/cms/logo1.png" height="35px" width="35px"> Sekolah Anak Saleh Malang</a>
            <!--logo end-->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            <div class="log-arrow-up"></div>
                                <li><a href="<?php echo base_url('tk/admin/reset-password'); ?>"><i class=" icon-cog"></i>Reset Password</a></li>
                                <li><a href="#"><i class="icon-bell-alt"></i> Notifikasi</a></li>
                                <li><a href="#"><i class="icon-envelope"></i> Pesan</a></li>
                                <li><a href="<?php echo base_url('tk/admin/login/logout'); ?>"><i class="icon-key"></i> Log Out</a></li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a class="active" href="<?php echo base_url('tk/admin/dashboard'); ?>">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?php echo base_url('tk/admin/pegawai'); ?>">Data Pegawai</a></li>
                          <li><a  href="<?php echo base_url('tk/admin/siswa/semua'); ?>">Data Siswa</a></li>
                          <li><a  href="<?php echo base_url('tk/admin/kelas'); ?>">Data Kelas</a></li>
                          <li><a  href="<?php echo base_url('tk/admin/mata-pelajaran'); ?>">Data Mata Pelajaran</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?php echo base_url('tk/admin/presensi-siswa'); ?>">Presensi Siswa</a></li>
                          <!--<li><a  href="<?php echo base_url('tk/admin/presensi-manual-siswa'); ?>">Presensi Siswa Manual</a></li>-->
                          <li><a  href="<?php echo base_url('tk/admin/presensi-pegawai'); ?>">Presensi Pegawai</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="<?php echo base_url();?>tk/admin/tagihan-spp">Tagihan SPP</a></li>
                          <!--<li><a  href="<?php echo base_url();?>tk/admin/pembayaran-lain">Biaya Lain</a></li>-->
                          <li><a  href="<?php echo base_url();?>tk/admin/kustom-spp">Kustom SPP Siswa</a></li>
                          <li><a  href="<?php echo base_url();?>tk/admin/buat-tagihan">Buat Tagihan</a></li>
                          <li><a  href="<?php echo base_url();?>tk/admin/data-tagihan">Data Tagihan</a></li>
                          <!--<li><a  href="<?php echo base_url();?>tk/admin/histori-tagihan">Histori Tagihan</a></li>-->
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="<?php echo base_url();?>tk/admin/tahun-ajaran">Tahun Ajaran</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="<?php echo base_url();?>tk/admin/laporan-keuangan">Laporan Keuangan</a></li>
                      </ul>
                  </li>
                  <li>
                      <a href="<?php echo base_url('tk/admin/pengumuman'); ?>" >
                          <i class=" icon-bell-alt"></i>
                          <span>Pengumuman </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('tk/admin/pesan'); ?>" >
                          <i class="icon-envelope"></i>
                          <span>Pesan </span>
                      </a>
                  </li>
                  <!--<li>
                      <a href="<?php echo base_url('tk/admin/pengguna'); ?>" >
                          <i class="icon-user"></i>
                          <span>Pengguna </span>
                      </a>
                  </li>-->
