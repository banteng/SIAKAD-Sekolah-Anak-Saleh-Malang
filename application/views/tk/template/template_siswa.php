                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="<?php echo base_url('tk/siswa/login/logout'); ?>"><i class="icon-key"></i> Log Out</a></li>
                        </ul>
                    </li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a class="active" href="<?php echo base_url('tk/siswa/dashboard'); ?>">
                  ...
                  <li>
                      <a href="<?php echo base_url('tk/siswa/absensi'); ?>" >
                          <i class=" icon-archive"></i>
                          <span>Absensi </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('tk/siswa/pembayaran'); ?>" >
                          <i class=" icon-dollar"></i>
                          <span>Pembayaran </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('tk/siswa/pengumuman'); ?>" >
                          <i class="icon-bell-alt"></i>
                          <span>Pengumuman </span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('tk/siswa/pesan'); ?>" >
