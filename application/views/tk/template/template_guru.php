      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                    <li>
                        <a class="active" href="<?php echo base_url('tk/guru/dashboard'); ?>">
                  ...
                  <?php if($this->db->query("SELECT * FROM tb_kelas WHERE WALI_KELAS ='".$this->session->userdata('nip')."'")){?>
                    <li>
                      <a href="<?php echo base_url('tk/guru/siswa'); ?>" >
                          <i class="icon-user"></i>
                  ...
                  <?php }?>
                   <li>
                      <a href="<?php echo base_url('tk/guru/penilaian'); ?>" >
                          <i class=" icon-file"></i>
                          <span>Penilaian </span>
                      </a>
                  </li>
                  <li>
                        <a href="<?php echo base_url('tk/guru/pengumuman'); ?>" >
                            <i class="icon-bell-alt"></i>
                            <span>Pengumuman </span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('tk/guru/pesan'); ?>" >
