                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="<?php echo base_url('tk/keuangan/login/logout'); ?>"><i class="icon-key"></i> Log Out</a></li>
                        </ul>
                    </li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a class="active" href="<?php echo base_url('tk/keuangan/dashboard'); ?>">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?php echo base_url();?>tk/keuangan/tagihan-spp">Tagihan SPP</a></li>
                          <li><a  href="<?php echo base_url();?>tk/keuangan/kustom-spp">Kustom SPP Siswa</a></li>
                          <li><a  href="<?php echo base_url();?>tk/keuangan/tagihan">Buat Tagihan</a></li>
                          <li><a  href="<?php echo base_url();?>tk/keuangan/data-tagihan">Data Tagihan</a></li>
                          <li><a  href="<?php echo base_url();?>tk/keuangan/histori-tagihan">Histori Tagihan</a></li>
                      </ul>
                  </li>
                  <li>
                      <a href="<?php echo base_url('tk/keuangan/penggajian'); ?>" >
                          <i class="icon-dollar"></i>
                  ...
                  <li>
                      <a href="<?php echo base_url('tk/keuangan/pilih-laporan'); ?>" >
                          <i class="icon-dollar"></i>
                          <span>Laporan Keuangan</span>
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo base_url('tk/keuangan/pesan'); ?>" >
