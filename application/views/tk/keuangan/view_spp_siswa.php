                                    ...
                                    <table  class="display table table-bordered table-striped" id="example">
                                      ...
                                      ?>
                                        <tr>
                                          ...
                                          <td><?php echo $data->KELAS;?> <?php echo $data->NAMA_KELAS;?></td>
                                          <td><?php echo $data->NISN;?></td>
                                          <td>
                                          <a href="#"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-eye "></i> Detail</button></a>
                                            <a href="<?php echo base_url();?>admin/home/editSiswa/<?php echo $data->NIS;?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o "></i> Edit</button></a>
