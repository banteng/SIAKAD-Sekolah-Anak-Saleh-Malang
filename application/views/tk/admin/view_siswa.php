...
<div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="btn-group">
                                 <a href="<?php echo base_url('tk/admin/tambah-siswa');?>"> <button class="btn green">Tambah Data <i class="icon-plus"></i>
                                  </button></a>
                              </div>
                                      ...
                                      ?>
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <a href="<?php echo base_url();?>tk/admin/home/editSiswa/<?php echo $data->NIS;?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o "></i> Edit</button></a>
                                        ...
                                        <div class="modal fade" id="modal_hapus<?php echo $data->NIS;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                                          ...
                                          <form class="form-horizontal" method="post" action="<?php echo base_url().'tk/admin/home/hapusSiswa/'.$data->NIS?>">
...
$(document).ready(function(){
    $('#pilihmapel').on('change', function(){
        var id = $(this).val();
        location.href = '<?php echo base_url("tk/admin/siswa/");?>'+id;
    })
    $('#tabelSoal').DataTable();
})
</script>
