<div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="btn-group">
                                 <a href="<?php echo base_url('paud/admin/tambah-presensi-siswa');?>"> <button class="btn green">Tambah Data <i class="icon-plus"></i>
                                  </button></a>
                              </div>
                              <div class="btn-group pull-right">
                                  ...
                                  <ul class="dropdown-menu pull-right">
                                      ...
                                      <li><a href="<?php echo base_url();?>paud/admin/home/laporanAbsensiSiswa">Export to Excel</a></li>
                                  </ul>
                              </div>
                                <div class="adv-table">
