...
{
	private $_template = "tk/template_admin";
    
	public function __construct()
	{
		parent::__construct();
		$this->load->model('tk/model_all');
		$this->load->model('tk/admin/model_admin');
	...
	function cek_sesi(){
	    if($this->session->userdata('isLoginAdminTK') == FALSE)
	    {
	...
	function showResetPassword()
	{
		...
		$data['page'] = 'tk/admin/view_reset_password';
		$this->load->view($this->_template,$data);
	}
	...
	function resetPassword()
	{
		...
		redirect("tk/admin/reset-password");
	}
	...
	public function tahunAjaran()
	{
		...
		$data['page'] = 'tk/admin/view_tahun_ajaran';
		$this->load->view($this->_template,$data);
	}
	...
	{ 
		...
		//print_r($this->db->last_query());die;
		redirect("tk/admin/tahun-ajaran");
	}
	...
	public function dataSiswa($id)
	{
        ...
        $data['kelas'] = $this->model_all->getAllKelasTK();
		$data['title'] = "Data Siswa - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'tk/admin/view_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	public function tambahSiswa()
	{
		...
		$data['page'] = 'tk/admin/view_tambah_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	public function prosesSiswa()
	{
		...
		$this->load->view($this->_template,$data);
		redirect('tk/admin/home/dataSiswa');
        }
	}
	...
	public function editSiswa($id)
	{
		...
		$data['page']  = 'tk/admin/view_edit_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	function importSiswa(){
        ...
        $data['page']  = 'tk/admin/view_import_siswa';
		$this->load->view($this->_template,$data);
    }
    ...
    function importPegawai(){
        ...
        $data['page']  = 'tk/admin/view_import_pegawai';
		$this->load->view($this->_template,$data);
    }
	public function dataPegawai()
	{
		...
		$data['page']  = 'tk/admin/view_pegawai';
		$this->load->view($this->_template,$data);
	}
	...
	public function tambahPegawai()
	{
		...
		$data['page']	= 'tk/admin/view_tambah_pegawai';
		$this->load->view($this->_template,$data);
	}
    ...
    public function prosesStatusPeg()
	{
		...
		redirect('tk/admin/status-pegawai');
	}
	...
	public function prosesPegawai()
	{
		...
		$data['page'] = 'tk/admin/view_tambah_pegawai';
		$this->load->view($this->_template,$data);
		redirect('tk/admin/home/dataPegawai');
	}
	...
	public function editPegawai($id)
	{
		...
		$data['page'] = 'tk/admin/view_edit_pegawai';
		$this->load->view($this->_template,$data);
	}
	...
	function detailPegawai(){    
	 ...
	 public function statusPegawai()
	 {
		 ...
		 $data['page']	= 'tk/admin/view_status_kepegawaian';
		 $this->load->view($this->_template,$data);
	 }
	 ...
	 public function tambahStatusPegawai()
	 {
		 ...
		 $data['page']	= 'tk/admin/view_tambah_status_pegawai';
		 $this->load->view($this->_template,$data);
	 }
	...
	public function tambahKelas()
	{
		...
		$data['page']	= 'tk/admin/view_tambah_kelas';
		$this->load->view($this->_template,$data);
	}
	...
	public function prosesKelas()
	{
		...
		//print_r($this->db->last_query());die;
		redirect('tk/admin/home/dataKelas');
	}
	...
	public function editKelas($id)
	{
		...
		$data['page'] = 'tk/admin/view_edit_kelas';
		$this->load->view($this->_template,$data);
	}
	...
	public function detailKelas($id)
	{
		...
		$data['page'] = 'tk/admin/view_detail_kelas';
		$this->load->view($this->_template,$data);
	}
	...
	public function tambahDetailKelas($id)
	{
		...
		$data['page'] = 'tk/admin/view_tambah_detail_kelas';
		$this->load->view($this->_template,$data);
	}
	//END DATA KELAS
	...
	public function dataPresensiSiswa()
	{
		...
		$data['page'] = 'tk/admin/view_presensi_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	public function tambahPresensiSiswa()
	{
		...
		$data['page'] = 'tk/admin/view_tambah_presensi_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	public function dataPresensiManualSiswa()
	{
		...
		$data['page'] = 'tk/admin/view_presensi_manual_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	public function dataPresensiPegawai()
	{
		...
		$data['page'] = 'tk/admin/view_presensi_pegawai';
		$this->load->view($this->_template,$data);
	}
	...
	public function presensiMasuk($id)
	{
		...
		redirect('tk/admin/home/dataPresensiManualSiswa');
	}
	...
	public function prosesPresensiSiswa()
	{
		...
		redirect('tk/admin/presensi-siswa');
		}else{
			$this->session->set_flashdata('status', "<strong>Data tidak lengkap!</strong>");
			$this->session->set_flashdata('clr', 'danger');
			redirect('tk/admin/tambah-presensi-siswa');
		}
	}
    ...
    public function tambahPresensiPegawai()
	{
		...
		$data['page'] = 'tk/admin/view_tambah_presensi_pegawai';
		$this->load->view($this->_template,$data);
	}
    ...
    public function prosesPresensiPegawai()
	{
		...
		redirect('tk/admin/presensi-siswa');
			...
			$this->session->set_flashdata('status', "<strong>Data tidak lengkap!</strong>");
			$this->session->set_flashdata('clr', 'danger');
			redirect('tk/admin/tambah-presensi-pegawai');
		}
	}
	...
	public function pengumuman()
	{
		...
		$data['page'] = 'tk/admin/view_pengumuman';
		$this->load->view($this->_template,$data);
	}
	...
	public function setPengumuman()
	{
		...
		$data['page'] = 'tk/admin/view_tambah_pengumuman';
		$this->load->view($this->_template,$data);
	}
	...
	public function prosesPengumuman()
	{
		...
		$this->model_all->setPengumuman('pengumuman', $data);*/
		redirect('tk/admin/home/pengumuman');
	}
	...
	public function detailPengumuman($id)
	{
		...
		$data['page'] = 'tk/admin/view_detail_pengumuman';
		$this->load->view($this->_template,$data);
	}
	...
	public function pengguna()
	{
		...
		$data['page'] = 'tk/admin/view_pengguna';
		$this->load->view($this->_template,$data);
	}
	...
	public function pembayaranLain()
	{
		...
		$data['page'] = 'tk/admin/view_pembayaran_lain';
		$this->load->view($this->_template,$data);
	}
	...
	public function tambahPembayaranLain()
	{
		...
		$data['page'] = 'tk/admin/view_tambah_pembayaran_lain';
		$this->load->view($this->_template,$data);
	}
	...
	public function prosesBayarLain()
	{
		...
		redirect('tk/admin/home/pembayaranLain');
	}
	...
	public function detailBayarLain()
	{
		...
		$data['page'] = 'tk/admin/view_detail_pembayaran_lain';
		$this->load->view($this->_template,$data);
	}
	...
	public function tagihanSPP()
	{
		...
		$data['page'] = 'tk/admin/view_tagihan_spp';
		$this->load->view($this->_template,$data);
	}
	...
	function detailSPP($id)
	{
		...
		$data['page'] = 'tk/admin/view_detail_tagihan_spp';
		$this->load->view($this->_template,$data);
	}
    ...
    public function tambahTagihan()
	{
		...
		//print_r($this->db->last_query());die;
        //print_r($data['spp']);die;
		$data['title'] = "Buat Tagihan SPP - TK Sekolah Anak Saleh Malang";

		$data['page'] = 'tk/admin/view_tambah_tagihan';
		$this->load->view($this->_template,$data);
	}
	...
	{
		$this->cek_sesi();
		$data['title'] = "Tagihan Siswa - TK Sekolah Anak Saleh Malang";
		...
		redirect('tk/admin/data-tagihan');
	}
	...
	function bayarSPP($id, $bulan)
	{
		...
		redirect("tk/admin/home/detailSPP/$id");
	}
	...
	function kustomSPP()
	{
		...
		$data['page'] = 'tk/admin/view_custom_spp';
		$this->load->view($this->_template,$data);
	}
	...
	function editSPP($id)
	{
		...
		redirect("tk/admin/home/kustomSPP");
	}
	...
	function dataTagihan()
	{
		...
		$data['page'] = 'tk/admin/view_data_tagihan';
		$this->load->view($this->_template,$data);
	}
	...
	function historiTagihan()
	{
		...
		$data['page'] = 'tk/admin/view_history_tagihan';
		$this->load->view($this->_template,$data);
	}
	//END PEMBAYARAN
	...
	function mataKuliah()
	{
		...
		$data['page'] = 'tk/admin/view_mata_pelajaran';
		$this->load->view($this->_template,$data);
	}
	...
	function tambahMataKuliah()
	{
		...
		$data['page'] = 'tk/admin/view_tambah_mata_pelajaran';
		$this->load->view($this->_template,$data);
	}
	...
	public function prosesMatkul()
	{
		...
		redirect('tk/admin/mata-pelajaran');
	}
	...
	public function laporanAbsensiSiswa(){
		...
		$this->load->view('tk/admin/laporan_absensi_siswa',$data);
   }
	//END LAPORAN
	...
	*/
    ...
    function pilihLaporan()
	{
		...
		$data['page'] = 'tk/admin/view_pilih_laporan';
		$this->load->view($this->_template,$data);
	}
     ...
     public function LaporanPembayaran()
	{
		...
		$data['spp'] = $this->model_all->getPembayaranTK($tahun);
		
		$this->load->view("tk/admin/laporan_pembayaran", $data);
	}
	...
	public function doImportSiswa()
    {
        ...
        if (!$this->upload->do_upload()) {
            ...
            redirect('tk/admin/import-siswa/');
        } else {
    ...
    public function doImportPegawai()
    {
        ...
        if (!$this->upload->do_upload()) {
            ...
            redirect('tk/admin/import-pegawai/');
        } else {
