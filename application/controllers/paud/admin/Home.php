...
{
	private $_template = "paud/template_admin";
    
	public function __construct()
	{
		parent::__construct();
		$this->load->model('paud/model_all');
		$this->load->model('paud/admin/model_admin');
	...
	function cek_sesi(){
	    if($this->session->userdata('isLoginAdminPaud') == FALSE)
	    {
	      redirect('paud/admin/login');
	    }else
	    {
	    
	      $this->load->model('paud/admin/model_login');
	...
	public function index()
	{
		...
		$data['page'] = 'paud/admin/view_awal';
	...
	function showResetPassword()
	{
		...
		$data['page'] = 'paud/admin/view_reset_password';
		$this->load->view($this->_template,$data);
	}
	...
	function resetPassword()
	{
		...
		redirect("paud/admin/reset-password");
	}

	public function tahunAjaran()
	{
		$this->cek_sesi();
		$data['title'] = "Tahun Ajaran - PAUD Sekolah Anak Saleh Malang";

		$data['tahun'] = $this->model_all->getTahunAktif();
		
		$data['page'] = 'paud/admin/view_tahun_ajaran';
		$this->load->view($this->_template,$data);
	}
	...
	{ 
		...
		//print_r($this->db->last_query());die;
		redirect("paud/admin/tahun-ajaran");
	}

	public function chat()
	{
		$this->cek_sesi();
		$data['title'] = "Chat - PAUD Sekolah Anak Saleh Malang";

		$data['siswa'] = $this->model_all->getAllSiswa();
		$data['page'] = 'paud/admin/view_chat';
		$this->load->view($this->_template,$data);
	}
	...
	{
		$this->cek_sesi();
		$data['title'] = "CMS - PAUD Sekolah Anak Saleh Malang";

		$data['cms'] = $this->model_all->getCMS();
		$data['ip'] = $this->model_all->getSettingIP();
		$data['page'] = 'paud/admin/view_cms';
		$this->load->view($this->_template,$data);
	}
	...
	public function dataSiswa($id)
	{
		...
		$data['kelas'] = $this->model_all->getAllKelasPAUD();

		$data['title'] = "Data Siswa - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'paud/admin/view_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	{
		$this->cek_sesi();
		$data['title'] = "Tambah Data Siswa | PAUD Sekolah Anak Saleh Malang";
		$data['kelas'] =  $this->model_all->getAllKelas();

		$data['page'] = 'paud/admin/view_tambah_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	public function editSiswa($id)
	{
		...
		$data['title'] = "Edit Data Siswa | PAUD Sekolah Anak Saleh Malang";
		$data['siswa'] =  $this->model_all->getSiswaById($id);
		$data['kelas'] =  $this->model_all->getAllKelas();

		$data['page']  = 'paud/admin/view_edit_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	function hapusSiswa($id){
		...
		redirect('paud/admin/home/dataSiswa');
	}
    
    function importSiswa(){
		$this->cek_sesi();
        $data['title']  = 'Import Data Siswa';
        $data['page']  = 'paud/admin/view_import_siswa';
		$this->load->view($this->_template,$data);
    }
    ...
    function importPegawai(){
        ...
        $data['page']  = 'paud/admin/view_import_pegawai';
		$this->load->view($this->_template,$data);
    }
	...
	{
		$this->cek_sesi();
		$data['siswa'] = $this->model_all->getAllPegawai();

		$data['title'] = "Data Pegawai - PAUD Sekolah Anak Saleh Malang";

		$data['page']  = 'paud/admin/view_pegawai';
		$this->load->view($this->_template,$data);
	}
	...
	public function tambahPegawai()
	{
		...
		$data['page']	= 'paud/admin/view_tambah_pegawai';
		$this->load->view($this->_template,$data);
	}
    ...
    public function prosesStatusPeg()
	{
		...
		redirect('paud/admin/status-pegawai');
	}
	...
	public function prosesPegawai()
	{
		...
		//$this->model_all->setPegawai('a_user', $data1);

		$data['page'] = 'paud/admin/view_tambah_pegawai';
		$this->load->view($this->_template,$data);
		redirect('paud/admin/home/dataPegawai');
	}
	...
	{
		$this->cek_sesi();
		$data['title'] 		= "Edit Data Pegawai | PAUD Sekolah Anak Saleh Malang";
		$data['pegawai'] 	=  $this->model_all->getPegawaiById($id);
		$data['status'] 	=  $this->model_all->getAllStatusPeg();

		$data['page'] = 'paud/admin/view_edit_pegawai';
		$this->load->view($this->_template,$data);
	}
	...
	function detailPegawai(){    
	 ...
	 {
		 $this->cek_sesi();
		 $data['title'] 	= "Status Kepegawaian | PAUD Sekolah Anak Saleh Malang";
		 $data['status'] =  $this->model_all->getAllStatusPeg();
 
		 $data['page']	= 'paud/admin/view_status_kepegawaian';
		 $this->load->view($this->_template,$data);
	 }
	 ...
	 {
		 $this->cek_sesi();
		 $data['title'] 	= "Tambah Status Siswa | PAUD Sekolah Anak Saleh Malang";
		 $data['status'] =  $this->model_all->getAllStatusPeg();
 
		 $data['page']	= 'paud/admin/view_tambah_status_pegawai';
		 $this->load->view($this->_template,$data);
	 }
	 ...
	 public function prosesStatusPegawai()
	{
		...
		redirect('paud/admin/dataPegawai');
	}
	...
	public function dataKelas()
	{
		...
		$data['title'] = "Data Kelas - PAUD Sekolah Anak Saleh Malang";

		$data['page']  = 'paud/admin/view_kelas';
		$this->load->view($this->_template,$data);
	}
	...
	{
		$this->cek_sesi();
		$data['title'] 	= "Tambah Data kelas | PAUD Sekolah Anak Saleh Malang";
		$data['wali'] =  $this->model_all->getAllPegawai();

		$data['page']	= 'paud/admin/view_tambah_kelas';
		$this->load->view($this->_template,$data);
	}
	...
	public function prosesKelas()
	{
		...
		//print_r($this->db->last_query());die;
		redirect('paud/admin/home/dataKelas');
	}
	...
	public function editKelas($id)
	{
		...
		$tahun 		   = $data['tahun']->TAHUN.$data['tahun']->SEMESTER;
        //print_r($tahun);die;
		$data['title'] 		= "Edit Data Kelas | PAUD Sekolah Anak Saleh Malang";
		$data['kelas'] 	=  $this->model_all->getKelasById($id);
        //print_r($kelas);die;
		$data['wali'] 	=  $this->model_all->getAllPegawai();

		$data['page'] = 'paud/admin/view_edit_kelas';
		$this->load->view($this->_template,$data);
	}
	...
	public function detailKelas($id)
	{
		...
		$data['title'] 		= "Detail Data Kelas | PAUD Sekolah Anak Saleh Malang";
		$data['kelas'] 	=  $this->model_all->getEnrollKelas($id, $tahun);
       
		$data['page'] = 'paud/admin/view_detail_kelas';
		$this->load->view($this->_template,$data);
	}
	...
	public function tambahDetailKelas($id)
	{
		...
		$data['page'] = 'paud/admin/view_tambah_detail_kelas';
		$this->load->view($this->_template,$data);
	}
	//END DATA KELAS
	...
	public function dataPresensiSiswa()
	{
		...
		$data['title'] = "Data Presensi Siswa - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'paud/admin/view_presensi_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	public function tambahPresensiSiswa()
	{
		...
		$data['page'] = 'paud/admin/view_tambah_presensi_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	public function dataPresensiManualSiswa()
	{
		...
		$data['page'] = 'paud/admin/view_presensi_manual_siswa';
		$this->load->view($this->_template,$data);
	}
	...
	public function dataPresensiPegawai()
	{
		...
		$data['title'] = "Data Presensi Pegawai - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'paud/admin/view_presensi_pegawai';
		$this->load->view($this->_template,$data);
	}
	...
	public function presensiMasuk($id)
	{
		...
		redirect('paud/admin/home/dataPresensiManualSiswa');
	}
	...
	public function prosesPresensiSiswa()
	{
		...
		redirect('paud/admin/presensi-siswa');
		}else{
			$this->session->set_flashdata('status', "<strong>Data tidak lengkap!</strong>");
			$this->session->set_flashdata('clr', 'danger');
			redirect('paud/admin/tambah-presensi-siswa');
		}
	}
    ...
    public function tambahPresensiPegawai()
	{
		...
		$data['page'] = 'paud/admin/view_tambah_presensi_pegawai';
		$this->load->view($this->_template,$data);
	}
    ...
    public function prosesPresensiPegawai()
	{
		...
		redirect('paud/admin/presensi-siswa');
			...
			$this->session->set_flashdata('status', "<strong>Data tidak lengkap!</strong>");
			$this->session->set_flashdata('clr', 'danger');
			redirect('paud/admin/tambah-presensi-pegawai');
		}
	}
	...
	public function pengumuman()
	{
		...
		$data['page'] = 'paud/admin/view_pengumuman';
		$this->load->view($this->_template,$data);
	}
	...
	public function setPengumuman()
	{
		...
		$this->cek_sesi();
		$data['siswa'] = $this->model_all->getAllSiswa();
		$data['tk'] = $this->model_all->getAllKelasTK();
		$data['paud'] = $this->model_all->getAllKelasPAUD();
        
	
		$data['title'] = "Tambah Pengumuman - PAUD Sekolah Anak Saleh Malang";
        
		$data['page'] = 'paud/admin/view_tambah_pengumuman';
		$this->load->view($this->_template,$data);
	}
	...
	function hapusPengumuman($id){
		...
		redirect('paud/admin/pengumuman');
	}
	...
	public function prosesPengumuman()
	{
		...
		$this->model_all->setPengumuman('pengumuman', $data);*/
		redirect('paud/admin/home/pengumuman');
	}
	...
	public function detailPengumuman($id)
	{
		...
		$data['page'] = 'paud/admin/view_detail_pengumuman';
		$this->load->view($this->_template,$data);
	}
	...
	public function pengguna()
	{
		...
		$data['title'] = "Pengguna - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'paud/admin/view_pengguna';
		$this->load->view($this->_template,$data);
	}
	...
	public function pembayaranLain()
	{
		...
		$data['page'] = 'paud/admin/view_pembayaran_lain';
		$this->load->view($this->_template,$data);
	}
	...
	public function tambahPembayaranLain()
	{
		...
		$data['page'] = 'paud/admin/view_tambah_pembayaran_lain';
		$this->load->view($this->_template,$data);
	}
	...
	public function prosesBayarLain()
	{
		...
		redirect('paud/admin/home/pembayaranLain');
	}
	...
	public function detailBayarLain()
	{
		...
		$data['title'] = "Tagihan SPP - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'paud/admin/view_detail_pembayaran_lain';
		$this->load->view($this->_template,$data);
	}
	...
	public function tagihanSPP()
	{
		...
		$data['page'] = 'paud/admin/view_tagihan_spp';
		$this->load->view($this->_template,$data);
	}
    ...
    public function getSPP()
	{
        ...
        $query = mysqli_query($koneksi, "select * from tb_enroll_spp where NIS='$nim'");
        $mahasiswa = mysqli_fetch_array($query);
        $data = array(
                    'nominal'      =>  $mahasiswa['NOMINAL_SPP'],);
	...
	function detailSPP($id)
	{
		...
		//print_r($data['spp']);die;
		$data['title'] = "Detail Tagihan SPP - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'paud/admin/view_detail_tagihan_spp';
		$this->load->view($this->_template,$data);
	}
	...
	function bayarSPP($id, $bulan)
	{
		...
		redirect("paud/admin/home/detailSPP/$id");
	}
	...
	function kustomSPP()
	{
		...
		$data['page'] = 'paud/admin/view_custom_spp';
		$this->load->view($this->_template,$data);
	}
	...
	function editSPP($id)
	{
		...
		redirect("paud/admin/home/kustomSPP");
	}
	...
	function dataTagihan()
	{
		...
		$data['title'] = "Data Tagihan - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'paud/admin/view_data_tagihan';
		$this->load->view($this->_template,$data);
	}
	...
	{
		$this->cek_sesi();
		$data['laporan'] = $this->model_all->getPembayaranKB();
		$data['spp'] = $this->model_all->getEnrollSPP();
		
		$data['title'] = "Data Tagihan - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'paud/admin/view_history_tagihan';
		$this->load->view($this->_template,$data);
	}
	...
	function mataKuliah()
	{
		...
		$data['title'] = "Data Mata Pelajaran - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'paud/admin/view_mata_pelajaran';
		$this->load->view($this->_template,$data);
	}
	...
	function tambahMataKuliah()
	{
		...
		$data['title'] = "Tambah Mata Pelajaran - PAUD Sekolah Anak Saleh Malang";

		$data['page'] = 'paud/admin/view_tambah_mata_pelajaran';
		$this->load->view($this->_template,$data);
	}
	...
	public function prosesMatkul()
	{
		...
		redirect('paud/admin/mata-pelajaran');
	}
	...
	public function laporanAbsensiSiswa(){
		...
		$this->load->view('paud/admin/laporan_absensi_siswa',$data);
   }
	//END LAPORAN
    ...
    function tambahPesan(){
		...
		$data = array(
			...
			'ID_PENERIMA' => $untuk,
			'PESAN' => $isi,
			'TANGGAL_KIRIM' => date("Y-m-d h:i:sa")
		);
		
		$this->model_all->tambahPesan('pesan', $data);
		redirect("paud/admin/pesan");
	}
	...
	function tambahPesan($id){
		...
		$data['title'] = "Tambah Pesan - PAUD Sekolah Anak Saleh Malang";
	...
	*/
    ...
    function pilihLaporan()
	{
		...
		$data['page'] = 'paud/admin/view_pilih_laporan';
		$this->load->view($this->_template,$data);
	}
    ...
    function laporan()
	{
        ...
        $data['title'] = "Laporan Keuangan - PAUD ANAK SALEH";
		$data['page'] = 'paud/admin/view_laporan';
		$this->load->view($this->_template,$data);
	}
    
  function laporanById($nis, $tahun)
	{
		$this->cek_sesi();
      
		$data['laporan']  = $this->model_all->LaporanPembayaranbyId($nis, $tahun);
		$data['mon']      = $this->model_all->getBulanSPP();
		//print_r($data['laporan']);die;
		$data['title']    = "Detail Tagihan SPP - PAUD Sekolah Anak Saleh Malang";

		$data['page']     = 'paud/admin/view_detail_laporan';
		$this->load->view($this->_template,$data);
	}
     ...
     public function LaporanPembayaran()
	{
        ...
        $data['tagihan']    = $this->model_all->getEnrollSPP();
		
		$this->load->view("paud/admin/laporan_pembayaran", $data);
	}
    
    function template(){
        $this->cek_sesi();
        $this->load->view("paud/admin/ekspor_siswa");
    }
    ...
    public function doImportPegawai()
    {
        ...
        if (!$this->upload->do_upload()) {
            ...
            redirect('paud/admin/import-pegawai/');
        } else {
