...
{
	private $_template = "sd/template/template_guru";
    
	public function __construct()
	{
		parent::__construct();
		$this->load->model('sd/model_all');
		$this->load->model('sd/guru/model_guru');
		$this->load->helper(array('url_helper', 'form', 'tglindo'));
		$this->load->library(array('form_validation', 'session', 'upload'));
	}

	function cek_sesi(){
	    if($this->session->userdata('isLoginGuruSD') == FALSE)
	    {
	...
	public function penilaian()
	{
		...
		$data['page'] = 'sd/guru/view_penilaian';
		$this->load->view($this->_template,$data);
	}
	...
	public function raportsiswa($id)
	{
		...
		$data['page'] = 'sd/guru/view_tambah_pengumuman_siswa';
		$this->load->view($this->_template,$data);
	}
    ...
    public function penilaiansiswa($id)
	{
		...
		$data['page'] = 'sd/guru/view_tambah_pengumuman_penilaian_siswa';
		$this->load->view($this->_template,$data);
	}
    ...
    public function prosesPengumuman()
	{
		...
		$this->model_all->setPengumuman('pengumuman', $data);
		redirect('sd/guru/home/pengumuman');
	}
    ...
    public function prosesPenilaian()
	{
		...
		$this->model_all->setPengumuman('pengumuman', $data);
		redirect('sd/guru/home/penilaian');
	}
	...
	public function pengumuman()
	{
		...
		$data['page'] = 'sd/guru/view_pengumuman';
		$this->load->view($this->_template,$data);
	}
	...
	public function setPengumuman()
	{
		...
		$data['page'] = 'sd/guru/view_tambah_pengumuman';
		$this->load->view($this->_template,$data);
	}
    ...
    public function unduhRaport($id)
	{
		...
		$data['page'] = 'sd/guru/view_data_raport';
		$this->load->view($this->_template,$data);
	}
     ...
     public function unduhPenilaian($id)
	{
		...
		$data['page'] = 'sd/guru/view_data_penilaian';
		$this->load->view($this->_template,$data);
	}
    ...
    function showResetPassword()
	{
		...
		$data['page'] = 'sd/guru/view_reset_password';
		$this->load->view($this->_template,$data);
	}
	...
	function resetPassword()
	{
		...
		//print_r($this->db->last_query());die;
		redirect("sd/guru/reset-password");
	}
