		<div class="row">
			...
			<div class="col-sm-3">
				<div class="alert bg-blue">
					<h4>NIM <i class="pull-right fa fa-graduation-cap"></i></h4>
			...
			<div class="col-sm-3">
				<div class="alert bg-red">
					<h4>Time <i class="pull-right fa fa-clock-o"></i></h4>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<h4>You will do the <?=$ju->nama_ujian;?> <?=$ju->mapel;?></h4>
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
												<a href="<?=base_url($ju->id_ujian);?>" class="btn btn-success">Start Exam</a>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="col-sm-12">
				<div class="box box-solid">
					<div class="box-header bg-red">
						<h4 class="box-title">History Exam</h4>
						<div class="box-tools pull-right">
							<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
						</div>
					</div>
