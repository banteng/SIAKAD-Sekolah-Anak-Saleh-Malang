...
<html lang="en">
<head>
	<title>Login - Sekolah Anak Saleh Malang</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="http://www.ids.sekolahanaksaleh.com/upload/cms/logo.png" alt="IMG">
				</div>
                
				<form class="login100-form validate-form" action="<?=base_url('Login/actlogin');?>" method="POST">
