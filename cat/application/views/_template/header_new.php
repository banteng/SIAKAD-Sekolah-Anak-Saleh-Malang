...
<body class="hold-transition skin-blue fixed sidebar-mini" oncontextmenu="return false;" style="-moz-user-select: none; cursor: default;">
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="<?php echo base_url();?>">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="<?=base_url();?>/assets/img/logo.png" alt="homepage" class="dark-logo" height="100px" width="100px"/>
                                <!-- Light Logo icon -->
                                <img src="<?=base_url();?>/assets/img/logo.png" alt="homepage" class="light-logo" height="50px" width="50px"/>
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                ...
                                <!-- Light Logo text -->
                                <!-- <img src="<?=base_url("template/assets/images/logo-light-text.png");?>" class="light-logo" alt="homepage" />-->
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="<?php echo base_url();?>template/assets/images/users/profile-pic.jpg" alt="user" class="rounded-circle"
                                    width="40">
    ...
    <?php require_once('sidebar_new.php');?>