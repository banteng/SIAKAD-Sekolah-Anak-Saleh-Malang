    ...
    <div class="user_options-text">
      <div class="user_options-unregistered div-logo">
        <div class="logo-smk">
          ...
          <h1>International Student Service</h1>
        </div>
      ...
      <div class="user_options-registered">
        <h2 class="user_registered-title">Cara reset password:</h2>
        <ol>
    ...
    <div class="user_options-forms" id="user_options-forms">
      <div class="user_forms-login">
        ...
        <form class="form padding-b" action="<?=base_url('Login/actlogin');?>" method="POST">
  		    <input type="text" name="nis" placeholder="NIM" autofocus required="" />
      ...
      <div class="user_forms-signup">
        ...
        <form class="form padding-b formnis">
          <input id="fnis" type="text" name="nis" placeholder="NIM" required>
          <i class="fa fa-user"></i>
          <p class="error-redB">NIM Not Found !</p>
        ...
        <form class="form padding-b formjawab">
            ...
            <i class="fa fa-key"></i>
            <p class="error-redB">Answer incorrect !</p>
            <button class="btn-jawab">Answer</button>
        </form>
        <form method="post" action="<?=base_url('Login/resetpasswd');?>" class="form padding-b formreset">
          ...
          <i class="fa fa-key"></i>
          <p class="error-redB">Password Incorrect !</p>
